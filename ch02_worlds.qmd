...
\$\$ P(T_2=1 \mid T_1=1)=\\ \frac{P(T_2=1, T_1=1)}{P(T_1=1)}=\\ \frac{P(T_2=1, T_1=1 \mid A) P(A) + P(T_2=1, T_1=1 \mid B) P(B)}{P(T_1=1 \mid A)P(A)+P(T_1=1 \mid B)P(B)}=\\ \frac{0.1 \cdot 0.1 \cdot 0.5 + 0.2 \cdot 0.2 \cdot 0.5}{0.1 \cdot 0.5 + 0.2 \cdot 0.5}=\frac{0.025}{0.15}=\frac{1}{6} \approx 0.17

\$\$

## 2H2 {#prac2H2 .unnumbered}
